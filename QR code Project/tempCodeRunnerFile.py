...
class QRgenerator():
    def __init__(self,root):
        ...
        title=Label(self.root,text="Student QR Code Generator",font=("new roman",40),bg="#053246",fg='white',anchor='w',padx=2).place(x=1,y=2)
...
#----QR code Windoww------
        ...
        self.QRcode=Label(QRFrame,text="No QR \nAvailable",font=('times new roman',15,'italic'),fg='white',bd=1,relief=RIDGE)
